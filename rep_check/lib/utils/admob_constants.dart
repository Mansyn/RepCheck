...
class AdmobConstants {
  ...
  static String appId = 'ca-app-pub-4892089932850014';
  ...
  static String interstitialAdUnitId = testing
      ? 'ca-app-pub-3940256099942544/1033173712'
      : realAdsInterstitialUnitId;

  static String nativeAdUnitId =
      testing ? 'ca-app-pub-3940256099942544/2247696110' : realAdsNativeUnitId;

  static String rewardVideoAdUnitId = testing
      ? 'ca-app-pub-3940256099942544/5224354917'
      : realAdsRewardVideoUnitId;
